...
const validate_user = require("../validations/validate_user");
...
Router.post("/", verifyToken, async(req, res) => {
  ...
  if (req_isvalid != true)
    ...
    try {
       ...
       if(!user)return res.status(403).json({error:true,errMessage:"invalid request, please login again to access this api"})
