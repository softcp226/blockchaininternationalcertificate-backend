  ...
  switch (payment_method) {
    case "BITCOIN":
      ...
      document.querySelector(
        ".wallet-div",
      ).innerHTML = `Send Bitcoin worth  $${amount.value} to this wallet: <b>bc1qvntrr2pumypd78xp72kvkkx59c686pdu30k8cj</b> and click "i have made payment" to submit payment screenshot/evidence of payment `;
      break;
    ...
    case "ETHEREUM":
      ...
      document.querySelector(
        ".wallet-div",
      ).innerHTML = `Send Ethereum worth  $${amount.value} to this wallet: <b>0x08C99F5e12A9C25059081926c2EeEeC2C6621e5E</b> and click "i have made payment" to submit screenshot/evidence of payment`;
      break;
    ...
    case "PERFECT MONEY":
        ...
        document.querySelector(
          ".wallet-div",
        ).innerHTML = `Send $${amount.value} to this Perfect money wallet id: <b>U37551138</b> and click "i have made payment" to submit screenshot/evidence of payment `;
    ...
    case "USDT":
      ...
      document.querySelector(
        ".wallet-div",
      ).innerHTML = `Send USDT worth  $${amount.value} to this wallet: <b>TRMh9ayrWtNx1CtEugN9yRHP4EnwHVyNPB</b> and click "i have made payment" to submit screenshot/evidence of payment`;
      break;
